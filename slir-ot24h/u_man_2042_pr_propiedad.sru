HA$PBExportHeader$u_man_2042_pr_propiedad.sru
forward
global type u_man_2042_pr_propiedad from u_man_0000_generico
end type
end forward

global type u_man_2042_pr_propiedad from u_man_0000_generico
int Width=2323
string DataObject="d_man_2042_propiedad"
boolean VScrollBar=true
end type
global u_man_2042_pr_propiedad u_man_2042_pr_propiedad
...
public function string f_datawindow ();return("d_man_2042_propiedad")
end function
...
public function string f_titulo ();return("OPEN SGI - Mantenimiento de Propiedades")
end function
...
on constructor;call u_man_0000_generico::constructor;This.SetSort("cod_prop_inst A")
This.Sort()
end on

event itemchanged;call super::itemchanged;// Setea los campos que estan ocultos en la datawindow
...
this.SetItem(this.getrow(),"codif",'PROP')
