HA$PBExportHeader$u_stn_indices_metas.sru
forward
global type u_stn_indices_metas from userobject
end type
type cb_1 from commandbutton within u_stn_indices_metas
end type
type cb_recuperar from commandbutton within u_stn_indices_metas
end type
type dw_filtro from datawindow within u_stn_indices_metas
end type
type cb_calcular from commandbutton within u_stn_indices_metas
end type
type cb_cierremensual from commandbutton within u_stn_indices_metas
end type
type cb_filtrar from commandbutton within u_stn_indices_metas
end type
type dw_activos from datawindow within u_stn_indices_metas
end type
type dw_periodo from datawindow within u_stn_indices_metas
end type
type gb_1 from groupbox within u_stn_indices_metas
end type
type gb_2 from groupbox within u_stn_indices_metas
end type
end forward
...
global u_stn_indices_metas u_stn_indices_metas
...
public subroutine uf_filtrar_activos_stn ()
end prototypes
...
on u_stn_indices_metas.destroy
destroy(this.cb_1)
...
//AHM (24/03/2010) Visualizaci$$HEX1$$f300$$ENDHEX$$n activos STR
dw_activos.Update()
