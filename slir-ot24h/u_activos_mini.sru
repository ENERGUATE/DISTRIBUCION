HA$PBExportHeader$u_activos_mini.sru
forward
global type u_activos_mini from userobject
end type
type dw_filtro from datawindow within u_activos_mini
end type
type cb_buscar from commandbutton within u_activos_mini
end type
type dw_activos from datawindow within u_activos_mini
end type
end forward
...
global u_activos_mini u_activos_mini
...
integer taborder = 20
string title = "none"
string dataobject = "d_filtro_activos_disponibilidades_mini"
...
integer taborder = 20
string title = "none"
string dataobject = "d_lista_activos_mini"
