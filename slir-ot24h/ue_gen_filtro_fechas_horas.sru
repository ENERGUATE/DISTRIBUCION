HA$PBExportHeader$ue_gen_filtro_fechas_horas.sru
forward
global type ue_gen_filtro_fechas_horas from datawindow
end type
end forward
...
int Height=212
int TabOrder=1
string DataObject="dw_gen_form_filtro_fechas_horas"
boolean Border=false
boolean LiveScroll=true
end type
global ue_gen_filtro_fechas_horas ue_gen_filtro_fechas_horas
