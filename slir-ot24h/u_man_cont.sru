HA$PBExportHeader$u_man_cont.sru
forward
global type u_man_cont from u_man_0000_generico
end type
end forward
...
int Width=1943
int Height=685
string DataObject="d_man_cont"
boolean VScrollBar=true
end type
global u_man_cont u_man_cont
...
public function string f_titulo ();RETURN ("OPEN SGI - Mantenimiento de Empresas Contratadas")
end function
...
SELECT count(*) INTO :ll_cantidad
FROM gi_brigadista
WHERE cod_contrata = :li_codigo;
...
this.SetItem(this.getrow(),"codif",'EMPR')
