HA$PBExportHeader$u_man_2020_pr_alc_avi.sru
forward
global type u_man_2020_pr_alc_avi from u_man_0000_generico
end type
end forward
...
int Width=1943
int Height=685
string DataObject="d_man_2020_alc_avi"
boolean VScrollBar=true
end type
global u_man_2020_pr_alc_avi u_man_2020_pr_alc_avi
...
public function string f_titulo ();RETURN ("OPEN SGI - Mantenimiento del Alcance del Aviso")
end function
...
int mesa, li_co_alcance
long ll_nro_aviso

SetPointer(HourGlass!)

li_co_alcance = This.GetItemNumber(This.GetRow(), "codigo")

SELECT nro_aviso INTO :ll_nro_aviso
FROM gi_avisos
WHERE co_alcance = :li_co_alcance AND rownum = 1;

IF ll_nro_aviso > 0 THEN
        gnv_msg.f_mensaje("EM27", " scope", " complents", Ok!)
        RETURN (-1)
END IF
...
this.SetItem(this.getrow(),"codif",'ALC')
