HA$PBExportHeader$w_str_detalle_indicadores_response.srw
forward
global type w_str_detalle_indicadores_response from window
end type
type dw_fecha from datawindow within w_str_detalle_indicadores_response
end type
type dw_indicadores from datawindow within w_str_detalle_indicadores_response
end type
end forward
...
global w_str_detalle_indicadores_response w_str_detalle_indicadores_response
...
if  ll_row_selected > 0 then 
	...
	dw_indicadores.object.codigo_grupo[1] = pdw_stn.object.codigo_grupo[ll_row_selected]
...
on w_str_detalle_indicadores_response.create
...
on w_str_detalle_indicadores_response.destroy
...
integer taborder = 10
string title = "none"
string dataobject = "d_str_detalle_indicadores_compensaciones"
boolean border = false
boolean livescroll = true
end type
...
this.GetChild("codigo_grupo", ldwc_descripcion_activo)
