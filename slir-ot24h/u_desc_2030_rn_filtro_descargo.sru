HA$PBExportHeader$u_desc_2030_rn_filtro_descargo.sru
forward
global type u_desc_2030_rn_filtro_descargo from nonvisualobject
end type
end forward

global type u_desc_2030_rn_filtro_descargo from nonvisualobject
end type
global u_desc_2030_rn_filtro_descargo u_desc_2030_rn_filtro_descargo

type variables
constant long sin_interrupcion = 2,con_interrupcion = 1
end variables
...
//		END IF
	...
	CASE "Actualizacion"
		...
		if gu_perfiles.of_acceso_perfil(gi_perfil,"DES_ACCESO","ACC_MANTEN")= 1 then 
...
CHOOSE CASE ps_accion_llamada
	...
	CASE "Consulta"
		...
		if gu_perfiles.of_acceso_perfil(gi_perfil,"DES_ACCESO","ACC_CONSULTA")= 0 then 
...
CHOOSE CASE ps_accion_llamada
	...
	if gu_perfiles.of_acceso_perfil(gi_perfil,"DES_ACCESO","ACC_MANTEN")= 0 then 
			pd_dw.Modify("ai_suministro.Protect=1")		// NO habilitado
			pd_dw.Modify("ai_suministro.BackGround.Color="+gs_gris)		//habilitado
...
//
	...
	if gu_perfiles.of_acceso_perfil(gi_perfil,"DES_ACCESO","ACC_ALTA")= 1 and  &
			...
			pd_dw.SetItem(1,"ai_alcance",pi_tension)		
			Return 1
		ELSEIF gu_perfiles.of_acceso_perfil(gi_perfil,"DES_ACCESO","ACC_ALTA")= 0 and  &
			gu_perfiles.of_acceso_perfil(gi_perfil,"DES_ACCESO","ACC_MEDIA")= 1 and  &
			gu_perfiles.of_acceso_perfil(gi_perfil,"DES_ACCESO","ACC_BAJA")= 0  THEN
			...
			Return 1
		ELSEIF gu_perfiles.of_acceso_perfil(gi_perfil,"DES_ACCESO","ACC_ALTA")= 0 and  &
			gu_perfiles.of_acceso_perfil(gi_perfil,"DES_ACCESO","ACC_MEDIA")= 0 and  &
			gu_perfiles.of_acceso_perfil(gi_perfil,"DES_ACCESO","ACC_BAJA")= 1  THEN
...
on u_desc_2030_rn_filtro_descargo.create
TriggerEvent( this, "constructor" )
end on

on u_desc_2030_rn_filtro_descargo.destroy
