HA$PBExportHeader$u_bdg_2006_nu_avisos_distribucion.sru
forward
global type u_bdg_2006_nu_avisos_distribucion from nonvisualobject
end type
end forward

global type u_bdg_2006_nu_avisos_distribucion from nonvisualobject
end type
global u_bdg_2006_nu_avisos_distribucion u_bdg_2006_nu_avisos_distribucion
...
//								 Modificaci$$HEX1$$f300$$ENDHEX$$n   25/09/2000   LFE GSH (VERSION 2000.1)
/////////////////////////////////////////////////////////////////////////
...
ls_select1 = 'SELECT ' + ls_max + ' (GI_AVISOS_BDG.NRO_CENTRO), '+&
						...
						'sum(GI_AVISOS_BDG.AVISO_C_INC) AVISO_C_INC, '+&
						'sum(GI_AVISOS_BDG.AVISO_S_INC_ALIM) AVISO_S_INC_ALIM, '+&
						'sum(GI_AVISOS_BDG.AVISO_S_INC_OTROS) AVISO_S_INC_OTROS, '+&
						'sum(GI_AVISOS_BDG.AVISOS_IMPROC) AVISOS_IMPROC, '+&
...
on u_bdg_2006_nu_avisos_distribucion.create
TriggerEvent( this, "constructor" )
end on

on u_bdg_2006_nu_avisos_distribucion.destroy
