...
This.SetItem(li_a,"campo","case when gi_avisos.US_REGISTRO IN (SELECT USUARIO FROM USUARIO WHERE PERMISOS LIKE 'OCM') then 'Oficina Comercial' else 'OT24' end generacion")
This.SetItem(li_a,"tabla","")
This.SetItem(li_a,"join","")
This.SetItem(li_a,"campo_inc","")
This.SetItem(li_a,"tipo","S")
